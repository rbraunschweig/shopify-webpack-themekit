...
const {sslKeyCert} = require('../utilities/ssl');
const isHotUpdateFile = require('../utilities/is-hot-update-file');
...
module.exports = class AssetServer {
  constructor(options) {
    ...
    this.client.hooks.afterSync.tap('HotMiddleWare', this._onAfterSync.bind(this));
  }
